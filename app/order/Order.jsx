...
const Order = () => {
  ...
  return (
    <View className='flex flex-col items-stretch justify-between h-full' style={{ backgroundColor: Th.backgroundColor }} >
      <ScrollView className=' px-5 py-2' >
            ...
            radioData.map((item, index) => {
              return (
                <Pressable
                  ...
                  style={{ backgroundColor: Th.black_bg_Color }}
                  key={index} className='flex rounded-2xl overflow-hidden justify-between p-3 items-end w-[48%] h-28 py-3 relative'
                >
                  <Text className='text-15 font-medium text-slate-500 text-right w-4/5' style={{ color: Th.gray_color }} >
                    {item.label}
                  </Text>
        ...
        <Text className='text-17 font-medium my-5' style={{ color: Th.color }}>
          {t('delivery_address')}
        </Text>
        <View>
          <Text className='text-11 font-medium mb-1' style={{ color: Th.color }} >
            {t('address')}
          </Text>
            ...
            cardData.map((item, index) => {
              return (
                <TouchableOpacity
                  ...
                  className='border border-slate-200 bg-white rounded-lg flex flex-row justify-between p-3 mb-4'
                >
      ...
      <View className='px-5 py-7 rounded-t-3xl' style={{ backgroundColor: Th.black_bg_Color }}
      >
        <View className='flex justify-between items-center flex-row border-b border-b-slate-400 mb-3 pb-3' >
          ...
          <Text className='text-15 font-medium' style={{ color: Th.color }}>
            8 {t('goods')}
          </Text>
        </View>
